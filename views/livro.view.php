...
$somaNotas = round($somaNotas / 5);

$notaFinal = str_repeat("⭐️", $somaNotas);
...
<div class="p-2 rounded bg-stone-900 border-stone-800 border-2">
        <div class="flex">
                ...
                <div class="space-y-1">
                        ...
                        <div class="text-xs italic"><?= $notaFinal ?>(<?= count($avaliacoes) ?>) Avaliação</div>
                </div>
        </div>
...
<div class="grid grid-cols-4 gap-4">
        ...
        <?php if (auth()): ?>
                <div class="border border-stone-700 rounded">
                        <h1 class="border-b border-stone-700 text-stone-400 font-bold px-4 py-2">O que achou?</h1>
                        <form class="p-4 space-y-4" method="post" action="/avaliacao-criar">
                                ...
                                <div class="flex flex-col">
                                        ...
                                        <label class="text-stone-400 ml-px mb-1">Avaliação</label>
                                        <textarea
                                                type="text"
                                                name="avaliacao"
                                ...
                                <div class="flex flex-col">
                                        <label class="text-stone-400 ml-px mb-1">Nota</label>
                                        <select
                                                name="nota"
                                                class="border-stone-800 border-2 rounded-md bg-stone-900 text-sm focus:outline-none px-2 py-1"
